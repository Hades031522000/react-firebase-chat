...
<style>
    .nav{
        border-bottom: 1px solid #fcdb03;
            ...
            <div class="item <?php if($i==0) {echo 'active';} ?>" style="background-image:url(assets/uploads/<?php echo $row['photo']; ?>);">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <h1 id="headertitle" class="w3-center w3-animate-top" data-animation="animated <?php if($row['position'] == 'Left') {echo 'zoomInLeft';} elseif($row['position'] == 'Center') {echo 'flipInX';} elseif($row['position'] == 'Right') {echo 'zoomInRight';} ?>"><?php echo $row['heading']; ?></h1>
                        </div>
...
#headertitle {
    ...
    font-weight: bold;
    color: transparent;
    background-image: linear-gradient(to right, rgb(255, 0, 0), rgba(255, 166, 0, 0.8));
    /* background-image: url('assets/uploads/video/RED-GRADIENTS-COLOR-SCHEME.jpeg');  */
...
<div class="product pt_90 pb_90">
    <!-- AMP auto ads script -->
    <amp-auto-ads type="adsense" data-ad-client="ca-pub-1255431402045409"></amp-auto-ads>
    <!-- end of AMP auto ads script -->
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="headline">
...
<?php require_once('autoplaycaroucelfooter.php'); ?>
<?php require_once('footer-video.php'); ?>
