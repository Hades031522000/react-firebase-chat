...
.footer-cookie {
  ...
  bottom: 0;
  width: 100%;
  background-color:rgba(255, 196, 0, 0.92);
  color: white;
  padding:25px 0;
  font-size:.8em;
}
...
<?php
// require_once('includes/cookie-footer.php');
...
<!-- <Div id="vidrow" class="row">
	...
	<div id="vidcol" class="col-md-4">
		<iframe width="420" height="300"
		src="https://www.youtube.com/embed/iPpC5XycxMo">
		</iframe>
	</div>
...
.par-contact{
	...
	background: transparent;
				...
				<form action="" method="post">
					...
					<h2 class="emailsub_title"><?php echo LANG_VALUE_93; ?></h2>
	...
	<div class="container">
		<div class="col inner">
			<div class="col-md-12 contact-footer">
					<p class="par-contact"><?php echo LANG_VALUE_167; ?></p>
					<p class="par-contact"><?php echo LANG_VALUE_166; ?></p>
					<p class="par-contact"><?php echo LANG_VALUE_165; ?></p>
					<p class="par-contact"><?php echo LANG_VALUE_164; ?></p>
				</div>
			</div>
			<div class="col inner">
				<div class="col-md-12 copyright">
					<?php echo $footer_copyright; ?><?php echo LANG_VALUE_168; ?>
				</div>
			</div>
		</div>
</div>
