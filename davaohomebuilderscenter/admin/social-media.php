...
if(isset($_POST['form1'])) {
	...
	$statement = $pdo->prepare("UPDATE tbl_social SET social_url=? WHERE social_name=?");
	$statement->execute(array($_POST['viber'],'Viber'));
...
foreach ($result as $row) {
	...
	if($row['social_name'] == 'Viber') {
		$viber = $row['social_url'];
	}
			...
			<form class="form-horizontal" action="" method="post">
				<div class="box box-info">
					<div class="box-body">						
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Viber </label>
							<div class="col-sm-4">
								<input type="text" class="form-control" name="viber" value="<?php echo $viber; ?>">
							</div>
						</div>
						<div class="form-group">
