...
<head>
	...
	<title>Davao Home Builders Center</title>
	...
	<!-- end of font awesome header icons -->
...
<!-- RECAPCHA code -->
  <script src="https://www.google.com/recaptcha/enterprise.js?render=6Lci0iMrAAAAADOil8-MEEQ1FLzMCOdL4Jey-gKH"></script>

  <script src="https://www.google.com/recaptcha/api.js?render=6Lca4CMrAAAAANyRHvoEtQtpADaM__dqzD8gS1fL"></script>
  <!-- end of recapcha code -->

	<!-- google adsense script -->
	<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1255431402045409"
...
<style>
	.top .container .row .left .fa{
		color:rgb(247, 252, 0);
	}
	.top{
		background-color:rgb(0, 0, 0);
	}
	.top .container .row .right .fa{
		/* color:rgb(247, 252, 0); */
		color: black;
	}
	.top .container .row .right fa-brands{
		color: black;
	}
	.top .container .row .right .bi{
		/* color:rgb(247, 252, 0); */
		color: black;
	}
	.header .container{
...
.header .right ul li a:hover {
	...
	border-radius: 5px;
	padding: 5px;
	background-color: rgba(15, 15, 14, 0.63);
}
...
<!-- end of Prevent Inspect Element -->
...
<div class="recapcha"> 
	...
	function onClick(e) {
		...
		const token = await grecaptcha.enterprise.execute('6Lci0iMrAAAAADOil8-MEEQ1FLzMCOdL4Jey-gKH', {action: 'LOGIN'});
		});
	}
	</script>
</div>
...
<script>
	...
	grecaptcha.ready(function() {
		grecaptcha.execute('6Lca4CMrAAAAANyRHvoEtQtpADaM__dqzD8gS1fL', {action: 'submit'}).then(function(token) {
	...
	<div class="container">
		<div class="row inner">
			<div class="col-md-5 logo">
				<a href="index.php" ><img title="Home" src="assets/uploads/<?php echo $logo; ?>" alt="logo image" ></a>
			</div>
					...
					-->
							...
							foreach ($result as $row) {
								...
								<!-- <ul>
										...
										foreach ($result1 as $row1) {
											?>
											<li  class="li_prod_cat"><a href="product-category.php?id=<?php echo $row1['mcat_id']; ?>&type=mid-category"><?php echo $row1['mcat_name']; ?></a>
												<ul>
													//start comment sa end catergory
													 <?php
