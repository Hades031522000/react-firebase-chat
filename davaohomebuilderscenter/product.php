...
.img-magnifier-glass {
    ...
    z-index: 10;
    pointer-events: none;
    /* Center the magnifier glass on the cursor */
...
<!--end of Magnifier Product Image CSS -->
					...
					<div class="row">
                        <div class="col-md-5">
                            <div class="img-magnifier-container">
                                <img id="mainProductImage" src="assets/uploads/<?php echo $p_featured_photo; ?>" style="width:100%;max-width:400px;" alt="<?php echo htmlspecialchars($p_name); ?>">
                            </div>
                            <div class="mt-2 d-flex flex-wrap">
                                <img class="img-thumbnail thumb-img" src="assets/uploads/<?php echo $p_featured_photo; ?>" style="width:60px;height:60px;object-fit:cover;cursor:pointer;margin-right:5px;" onclick="changeMainImage(this)">
                                <?php
                                ...
                                foreach ($result as $row) {
                                    ?>
                                    <img class="img-thumbnail thumb-img" src="assets/uploads/product_photos/<?php echo $row['photo']; ?>" style="width:60px;height:60px;object-fit:cover;cursor:pointer;margin-right:5px;" onclick="changeMainImage(this)">
                                    <?php
                                }
                                ?>
                            </div>
...
<!-- zoom product image js code -->
<script>
// Improved magnifier: hide glass when mouse leaves image or glass, or when pointer is outside image
function magnify(imgID, zoom) {
    var img = document.getElementById(imgID);
    var oldGlass = document.querySelector('.img-magnifier-glass');
    ...
    function moveMagnifier(e) {
        ...
        e.preventDefault();
        // Hide glass if pointer is outside image
    ...
    function getCursorPos(e) {
        ...
        var x = (e.touches ? e.touches[0].pageX : e.pageX) - a.left - window.pageXOffset;
        var y = (e.touches ? e.touches[0].pageY : e.pageY) - a.top - window.pageYOffset;
        return {x: x, y: y};
    }

    img.addEventListener("mouseenter", function() { glass.style.display = "block"; });
    glass.addEventListener("mouseenter", function() { glass.style.display = "block"; });
    img.addEventListener("mouseleave", function() { glass.style.display = "none"; });
    glass.addEventListener("mouseleave", function() { glass.style.display = "none"; });
...
<!--end zoom product image js code -->
